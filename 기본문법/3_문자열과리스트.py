...
print(colors[0])
print(colors[2]) #마지막 요소
print(colors[-1]) #마지막 요소
print(colors[-2]) #끝에서 두번째 blue
...
#(3) remove() : 리스트 내의 특정값 제거
colors.remove("white")
print(colors)
#값이 여러개인 경우 맨 처음 하나만 제거된다.
...
#마지막 학생 점수
print(midtermScores[0][-1]) #4번째 학생 국어점수
print(midtermScores[1][-1]) #4번째 학생 수학점수
print(midtermScores[2][-1]) #4번째 학생 영어점수
...
#-----------------------------------------------------
#파이썬 리스트의 특수성
#(1) 언패킹(unpacking) : List같은 컬렉션 데이터들을 각각 변수에 할당
colors = ['red','blue','green']
c1,c2,c3 = colors
print(c1,c2,c3)
