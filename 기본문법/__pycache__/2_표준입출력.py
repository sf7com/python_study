...
#(1-1) % 포맷팅 자릿수 지정
print("이름:%10s,나이:%4d,키:%2.1f" 
                %(name, age, height))

print("이름:%-10s,나이:%04d,키:%08.1f" 
                %(name, age, height))
#(2) {} 포맷팅
print("이름:{},나이:{},키:{}".format(name,age,height))
print("이름:{0}{0} \
     나이:{1}{0},키:{2}".format(name,age,height))
#(2-1) 자릿수 지정
#'^' : 가운데 정렬, '<' : 왼쪽정렬, '>' : 오른쪽 정렬
print("이름:{0:^10},나이:{1:<5},키:{2:>10.2f}"\
    .format(name,age,height))
#(2-2) 자릿수 문자 채우기
print("이름:{0:-^10},나이:{1:0<5},키:{2:0>10.2f}"\
    .format(name,age,height))
print("이름:{0:a^10},나이:{1:b<5},키:{2:c>10.2f}"\
    .format(name,age,height))
...
#(3-1) 자릿수 지정
print(f"이름:{name:-^10}, \
    나이:{age:a<5}, 키:{height:b>8.2f}")
print(f"이름:{name:^10}, \
    나이:{age:<5}, 키:{height:>8.2f}")
